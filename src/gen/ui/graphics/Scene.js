...
import apriltags from "../../../ui/config/apriltags.js";
...
export class Scene {
    ...
    init() {
        ...
        this.camera = new THREE.PerspectiveCamera(100, canvas.offsetWidth / canvas.offsetHeight, 0.1, 1000); // Approx. 35mm
        ...
        this.redrawFrame();
        // Field floor
        //team area starts at +-8.77376587156
        //1755 x 805 cm
        ...
        // Robot object
        // const robotGeom = new THREE.BoxGeometry(0.5, 0.2, 0.5);
    ...
    redrawFrame() {
        ...
        this.renderer.setSize(1280, 800, false);
    }
